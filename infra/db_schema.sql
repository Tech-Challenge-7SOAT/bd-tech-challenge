...
CREATE TABLE public.tb_role_admin (
 cpf character varying(255) NOT NULL
);
...
$do$
BEGIN
   IF NOT EXISTS (SELECT 1 FROM public.tb_role_admin WHERE cpf = '12345678911') THEN
      INSERT INTO public.tb_role_admin (cpf) VALUES ('12345678911');
   END IF;
END
$do$